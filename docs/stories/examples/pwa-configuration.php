        ...
        'default' => [
            'web' => [
                'graphql' => [
                    ...
                    'cors_allowed_headers' => 'Content-Currency, Store, X-Magento-Cache-Id',
                    // Angular
                    // 'cors_allowed_origins' => 'http://localhost:4200, https://localhost:4200',
                    // Angular + Universal
                    // 'cors_allowed_origins' => 'http://localhost:4200, https://localhost:4200, http://localhost:4000, https://localhost:4000',
                    // Express
